...
stack and therefore executes in linear time depending on size of the call stack.

**complexity**: Database accesses as described in Transfer + 1 DB write that removes
the contract when flushed to storage.
